<?php require_once "includes/modification.php";
                ...
                <form action="" method="POST"  enctype="multipart/form-data">
                    <div class="item-infos">
                        <div class="details">
                            ...
                            <div class="input-field">
                                <input type="Text" name="title" placeholder="Ezen a néven lesz kereshető a termék" value="<?php echo $title ?>">
                            </div>
                        </div>
                    </div>
                    <div class="item-infos">
                    ...
                    <div class="item-infos"> 
                        <div class="details">
                            ...
                            <div class="input-field">
                                <input type="text" name="brand" placeholder="Márka" value="<?php echo $brand ?>">
                            </div>
                        </div>
                    </div>
                    <div class="item-infos">
                        <div class="details">
                            <h2>
                                ...
                                <textarea name="desc" type="text"><?php echo $desc ?></textarea>
                        </div>
                    </div>
                    <div class="item-infos">
                        <div class="details">
